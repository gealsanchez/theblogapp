...
**[Blog_App]** is a classic example of a blog website. You can see the list of posts and empower readers to interact with them by adding comments and liking posts.
...
```sh
  cd my-folder
  git clone git@github.com:gealsanchez/theblogapp.git
```
